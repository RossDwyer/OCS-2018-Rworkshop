...
leaflet() %>%
  ...
  hideGroup(c("A69-1303-63639","A69-1303-63640","A69-1303-63643"))
...
blacktip[Transmitter == "A69-1303-63639", .(Receiver, Latitude, Longitude),] # Subsets Receiver, Latitude and Longitude data from Transmitter "A69-1303-63639"

## Aggregate numbers of detections from each of the three tagged animal
blacktip[ , .(.N), by = "Transmitter"]
```
...
blacktip[ , .(.N), by = c("Transmitter", "Receiver")]
```
