...
=======
1.  **import** our large data files using data.table
2.  **filter** our data using %pipes% the [tidyverse](http://tidyverse.org/) group of R packages
3.  advanced plotting using [ggplot2](http://ggplot2.org/) and Rcolourbrewer

* Session 2:

4.  Working with spatial objects
5.  Export and Import  of Shapefiles
6.  Animations 
7.  Integration with Google Earth
8.  Generate interactive maps using [leaflet](http://leafletjs.com/) 
