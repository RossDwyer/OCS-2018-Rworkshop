...
Once you have the `Spatial` object the way you like it, you will want to export it to view in a GIS. 

In this example we use the `writeOGR()` function in the rgdal package to write the data containing the movement metrics to a shapefile. We specify the data to be written within the GIS folder.
