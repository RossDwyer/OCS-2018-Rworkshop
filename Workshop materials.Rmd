...
install_github("RossDwyer/VTrack") # Install development version of VTrack directly from github
library(VTrack)
...
jacko_move<- move(x = jacko$Longitude.coa, y = jacko$Latitude.coa, time = jacko$dt,
                  proj = CRS("+init=epsg:4326"), data = jacko)
```
...
# Now we can use the mcp() fuction to calculate mcps
