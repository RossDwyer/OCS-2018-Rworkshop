...
leaflet() %>%
  ...
  addLayersControl(
    #baseGroups = c("Map","Satellite"),
    overlayGroups = c("Centers of Activity", "Minimum Convex Polygon", "Fixed KUD", "Brownian Bridge KUD"),
    options = layersControlOptions(collapsed = FALSE)) %>%

  
  hideGroup(c("Centers of Activity", "Minimum Convex Polygon", "Fixed KUD", "Brownian Bridge KUD"))
