...
```
**Additional Task: Add the detections of "Gecko" the croc (from the `crocs` dataset) to this leaflet plot. [hint: you will have to use `left_join()` to merge the receiver location to the crocs dataset]**
...
**BONUS SECTION: For the eager folk who want to progress onto more advanced utilisation distribution models, the following section will help get you get your head around Brownian bridge models. We will not be going through this at the workshop (for lack of time), but you can work through this on your own time.**
