...
For this session, we will need the most recent version of the `VTrack` package from CRAN.

```{r, eval=FALSE}
library(VTrack) # Version 1.2 has new COA functionality and works more effectively with Station names
```
